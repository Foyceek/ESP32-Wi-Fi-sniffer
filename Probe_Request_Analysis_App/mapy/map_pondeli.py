...
df = pd.read_csv('pondeli_final.csv', encoding='utf-8')

# Read packet data
packet_df = pd.read_csv('anonymized_relevant_data_pondeli.csv')
...
STOP_ORDER = [
    ...
    "Bráfova",
    "Stránského",
    "Bystrc, Rakovecká - nástup",
    "Bystrc, Rakovecká - výstup",
    "Přístaviště",
    "Bystrc, ZOO",
    "Kamenolom",
    "Podlesí",
...
def plot_segments_unified_heatmap(segments, packet_df):
    ...
    # Add title
    ax.set_title("Pondělí, Linka 3 - Hustota zachycených probe requestů", 
    ...
    plt.subplots_adjust(bottom=0.25, top=0.93, left=0.05, right=0.98)
